# -*- coding: utf-8 -*-
#
# linop documentation build configuration file, inspired from Pykrylov
#
...
sys.path.append(os.path.abspath('../../linop'))
...
latex_documents = [
  ('contents', 'linop.tex', ur'linop documentation',
   ur'G. Vaillant', 'manual'),
]
